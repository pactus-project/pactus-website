...
The Tokyo release introduces a new wallet engine that processes each block, extracts wallet-related transactions,
and stores them in a database.

This version specifically enables third-party applications to
[integrate with the Pactus](https://docs.pactus.org/tutorials/integration-guide/)
...
![Transaction page in Pactus GUI]({{<image "transaction-page-pactus-gui.png">}})
