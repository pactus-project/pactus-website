...
description = "Running a validator on Testnet is one of the most impactful ways you can contribute to the growth and resilience of the Pactus blockchain."
author = "Pactus Team"
...
To interact with the Pactus Testnet, you’ll need test coins **(tPAC)**. You can request up to 5 **tPAC** per day from [Pagu](https://pagu.bot), in our [Discord server](https://discord.gg/fEdJj84uxZ) / [Telegram chat](https://t.me/pactuschat). This makes it easy to experiment with sending transactions.
...
Decentralization thrives when the community is active, and this is one of the simplest yet most meaningful ways to contribute. If you’re ready to get started, the [Pactus Testnet Documentation](https://docs.pactus.org/tutorials/pactus-testnet) walks you through everything you need to know. You can also learn more about what a [Testnet](https://pactus.org/2023/03/31/what-is-testnet) is, read the full [Phoenix Testnet announcement](https://pactus.org/2024/03/16/pactus-permanent-phoenix-testnet-launched), or track activity live through the [Phoenix Explorer](https://phoenix.pacviewer.com). And if you ever get stuck, don’t worry, the team is always ready to help through Discord tickets.
